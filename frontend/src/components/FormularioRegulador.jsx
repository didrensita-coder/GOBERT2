...
import { Save, RotateCcw, ArrowLeft, ChevronRight, ChevronLeft, AlertCircle, Star, Heart, Zap, AlertTriangle } from 'lucide-react';
import { getEquipos, createEquipo, getDepartamentos } from '../services/api';
import ImageUpload from './ImageUpload';

const FormularioRegulador = ({ equipos, setEquipos }) => {
  ...
  const opcionesUso = [
    { id: 'critico', nombre: '🔴 EQUIPO CRÍTICO', descripcion: 'Protege equipos esenciales para operaciones diarias.', color: 'red', bg: 'bg-red-50', border: 'border-red-400', icon: AlertCircle },
    { id: 'importante', nombre: '🟡 EQUIPO IMPORTANTE', descripcion: 'Protege equipos de uso frecuente.', color: 'yellow', bg: 'bg-yellow-50', border: 'border-yellow-400', icon: Star },
    { id: 'basico', nombre: '🟢 EQUIPO BÁSICO', descripcion: 'Protege equipos de uso ocasional.', color: 'green', bg: 'bg-green-50', border: 'border-green-400', icon: Heart }
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      mostrarNotificacion('⚡ ¡Regulador registrado exitosamente!', 'success');
      ...
      if (errorMsg.includes('código') || errorMsg.includes('unique') || errorMsg.includes('Ya existe')) {
        ...
        setErrorMessage(errorMsg || 'Error al registrar el regulador');
        ...
        <div className="bg-white rounded-2xl shadow-xl mb-6 p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">
              ⚡ Registrar Regulador / Protector
            </h2>
            <div className="flex gap-2">
              {[1, 2, 3, 4].map((s) => (
                <div key={s} className="text-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all
                    ${step >= s ? 'bg-gradient-to-r from-yellow-500 to-orange-500 text-white' : 'bg-gray-200 text-gray-500'}
                    ${step === s ? 'ring-4 ring-yellow-200 scale-110' : ''}`}>
                    {s}
                  </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <form onSubmit={handleSubmit}>
            <div className="p-8">
              {step === 1 && (
                <div className="animate-fadeIn">
                  <div className="text-center mb-8">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Clasificación del Regulador</h3>
              ...
              {step === 2 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl font-bold text-gray-800 mb-6">📋 Datos del Regulador</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input 
                        ...
                        placeholder="Ej: REG-001, PROT-001"
                    ...
                    <div>
                      ...
                      <input type="text" name="usuario_asignado" value={formData.usuario_asignado} onChange={handleChange}
                        placeholder="Persona responsable del regulador"
                    ...
                    <div>
                      ...
                      <input type="text" name="marca" value={formData.marca} onChange={handleChange}
                        placeholder="Ej: APC, TRIPP LITE, FORZA"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500"
                        required />
                    </div>
              ...
              {step === 3 && (
                <div className="animate-fadeIn">
                  <h3 className="text-xl font-bold text-gray-800 mb-6">📸 Foto del Regulador</h3>
                  <ImageUpload
                    onImageChange={setPhotoFile}
                    tipo="equipo"
                    label="Foto del Regulador"
                  />
                </div>
              )}
                ...
                <div className="animate-fadeIn">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="5"
                      placeholder="Notas adicionales sobre el regulador (capacidad, número de tomas, estado físico, etc.)..."
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500"
                    />
                  </div>
                </div>
              ...
              <div className="flex justify-between mt-8 pt-6 border-t">
                ...
                {step < 4 && (
                  <button type="button" onClick={nextStep}
                    className="px-6 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:shadow-lg ml-auto flex items-center gap-2 transition">
                ...
                {step === 4 && (
                  <div className="ml-auto flex gap-3">
                    ...
                    <button type="submit" disabled={loading}
                      className="px-6 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:shadow-lg flex items-center gap-2 disabled:opacity-50 transition">
                      <Save size={16} />
...
export default FormularioRegulador;